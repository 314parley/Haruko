...
--
-- Host: localhost
-- Generation Time: May 20, 2015 at 05:58 AM
...
--
-- Table structure for table `bruteforce_tries`
--
...
--
-- Dumping data for table `bruteforce_tries`
--
...
('global_message', 'This is a Haruko based Imageboard!'),
('news_url', 'news.html'),
('sitename', 'Haruko'),
('enable_api', '1'),
('enable_rss', '0'),
...
--
-- Table structure for table `module_boardconfig`
--
...
--
-- Dumping data for table `module_boardconfig`
--
...
CREATE TABLE IF NOT EXISTS `module_fields` (
  ...
  PRIMARY KEY (`namespace`,`name`,`type`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `rangebans`
--
...
--
-- Dumping data for table `rangebans`
--
...
INSERT INTO `styles` (`id`, `name`, `path`, `relative`, `default`) VALUES
(6, 'Mitsuba', './css/mitsuba.css', 1, 0),
(7, 'Mitsuba Blue', './css/mitsubablue.css', 1, 0),
(8, 'Dark Roach', './css/dark roach.css', 1, 0),
(9, 'Yotsuba', './css/yotsuba.css', 1, 1),
(10, 'Yotsuba Blue', './css/yotsubablue.css', 1, 0),
(11, 'Photon', './css/photon.css', 1, 0);
